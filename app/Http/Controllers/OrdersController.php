...
class OrdersController extends Controller
{
    ...
    public function store()
    {
        ...
        try {
            ...
            $obj->Send['ReturnURL']         = "http://localhost:8000/order/callback" ;    //付款完成通知回傳的網址
            $obj->Send['PeriodReturnURL']         = "http://localhost:8000/order/callback" ;    //付款完成通知回傳的網址
            $obj->Send['ClientBackURL'] = "http://localhost:8000/success" ;    //付款完成通知回傳的網址
